...
export default function DomeGallery({
  ...
  return (
    <>
      ...
      >
        <div className="mt-10 lg:w-5/12 flex flex-col justify-start">
          <h1 className="text-5=xl lg:text-4xl font-light leading-tight">
            Previous
            Technika
          </h1>
        ...
        >
          <div className="stage mt-10">
            <div ref={sphereRef} className="sphere mt-20">
              {items.map((it, i) => (
                <div
                  key={`${it.x},${it.y},${i}`}
