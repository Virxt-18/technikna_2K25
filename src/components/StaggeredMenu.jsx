...
export const StaggeredMenu = ({
  position = "right",
  // THEME: dark red prelayers instead of blue
  colors = ["#050509", "#7f1d1d", "#991b1b"],
  items = [],
  displayItemNumbering = true,
  className,
  // THEME: default logo path for your site (can still be overridden by props)
  logoUrl = "/images/technika-logo.png",
  menuButtonColor = "#fff",
  openMenuButtonColor = "#fff",
  changeMenuColorOnOpen = true,
  isFixed = false,
  // THEME: accent red used in numbering / socials
  accentColor = "#ef4444",
  onMenuOpen,
  onMenuClose,
}) => {
  ...
  /* THEME: dark glass panel instead of white */
  .sm-scope .staggered-menu-panel {
    poimport StaggeredMenu from '../../../ts-default/Components/StaggeredMenu/StaggeredMenu';
    sition: absolute;
    top: 0;
    right: 0;
  ...
  /* THEME: socials text color now light */
  ...
  /* THEME: menu items white on dark */
  ...
  .sm-scope .sm-panel-list[data-numbering] .sm-panel-item { padding-right: 0.7em; }
